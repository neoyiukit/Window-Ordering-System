...
public class BodyBuilder {
    public static RequestBody bodyBuilderForAnyOrders(int widthOfWindow, int heightOfWindow, int numberOfWindow, int widthThicknessAllowance, int heightThicknessAllowance, String windowType) {
